...
class Profile extends Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        Axios.post('/api/profile/submit', { form: this.state.form }).then((res) => {
            console.log(res)
        })
    }
                        ...
                        <div id="left" className="col">
                            ...
                            <div className="FormField">
                                ...
                                <input type="job" id="job" className="FormField__Input form-control"
                                    placeholder="Enter your job" name="job" value={this.state.form.job}
                                    onChange={this.handleChange} />
                            </div>
                    ...
                    <div id="sec3" className="form-row container">
                        <div className="FormCenter col-12">
                            ...
                            <textarea type="tags" id="tags" className="FormField__Input form-control"
                                placeholder="Tag yourself" name="tags" value={this.state.form.tags}
                                onChange={this.handleChange} />
                        </div>
                    </div>
                    {/* end section 3 */}
